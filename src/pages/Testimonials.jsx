          ...
          <div className="md:w-1/2">
            <div className="relative flex justify-center items-center">
              <div className="w-[400px] h-[300px] bg-primary rounded-t-[155px] rounded-b-[41px] absolute mt-90 left-1/3 transform -translate-x-1/2 -translate-y-1/2 z-[-1]">
                <img
                  src="/hero-2.png"
                  className="relative w-[260px] h-auto top-[-109px] left-15"
                  alt=""
                />
              </div>
            </div>
            ...
            <div className="text-left">
              ...
              <div className="flex items-center gap-4 flex-wrap">
                <div className="flex -space-x-6 rtl:space-x-reverse">
                  <img src="/hero-3.png" className="w-[70px] h-[70px]" alt="" />
                  <img src="/hero-4.png" className="w-[70px] h-[70px]" alt="" />
                  <img src="/hero-5.png" className="w-[70px] h-[70px]" alt="" />
                </div>
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-[#454545]">
                      4.9{" "}
                      <small className="text-[#807E7E]">(18.6k Reviews)</small>
                    </span>
                  </div>
                </div>
              </div>
