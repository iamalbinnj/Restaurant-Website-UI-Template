function Culinary() {
  ...
  return (
    <>
      <div className="container max-w-screen-2x1 mx-auto xl:px-24 my-26">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="md:w-1/2">
            <div className="text-left">
              ...
              <button className="primary-button w-[120px] h-[50px]  px8 py-3 font-semibold">
                Explore
              </button>
            </div>
          </div>
          <div className="md:w-1/2">
            <div className="grid sm:grid-cols-2 grid-cols-1 gap-8 items-center">
              {culinaryList.map((item, index) => (
                <div key={index} className="shadow-2xl rounded-[45px] py-5 px-4 text-center space-y-2 text-primary">
